...
const Blogs = () =>
{
    ...
    return(
        <div className="flex flex-col gap-y-7 py-8  mb-[60px] h-full w-11/12 justify-center items-center">
            {/* w-11/12 max-w-[650px] flex flex-col gap-y-7 py-8 mt-[60px] mb-[60px] h-full justify-center items-center */}
        {
            loading ? (<Spinner/>):
